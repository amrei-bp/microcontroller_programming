...
![The MakeCode interface: simulator (left), toolbox (middle), workspace (right). The `on start` and `forever` blocks are already placed in the workspace when you create a new project.](figures/user_interface.png){fig-align="center" width="100%"}
