...
The gold band along the bottom is the **edge connector**. The three large holes — labelled **0**, **1**, and **2** — are general-purpose input/output pins: connect sensors here with crocodile clips or the Sensorbit. **3V** supplies power to connected components; **GND** completes the circuit. [@cr-front]{pan-to="0%,-90%" scale-by="1.5"}
...
The small component close to the speaker is the backside of the **microphone** — on the front you will see it as a little whole. It detects sound level and can recognise loud events such as claps or shouts. The LED you saw on the front indicates when it is active. [@cr-back]{pan-to="13%,33%" scale-by="2.4"}
...
The two  chips on the bottom left are the **accelerometer** and **compass**. The accelerometer measures forces in three dimensions — tilt, shake, freefall, movement. The compass detects magnetic north. Both are available as built-in sensor blocks in MakeCode, no extra wiring needed. [@cr-back]{pan-to="26%,-13%" scale-by="1.6"}

That is the complete micro:bit V2. Front and back, now you know what every component does. [@cr-back]{scale-by="1"}
